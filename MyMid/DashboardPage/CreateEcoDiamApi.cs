...
{
    internal class CreateEcoDiamApi : Login
    {
        [Test]
        public void JsonApiTest()
        {
            ...
            apiBtn.Click();
            IWebElement addEcoDiamApi = wait.Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(".btn:nth-child(2)")));
            addEcoDiamApi.Click();
            ...
            IWebElement chooseMember = wait.Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(".completer-list-item-holder")));
            chooseMember.Click();
            ...
            Assert.That(actualText, Is.EqualTo(expectedText), "The EcoDiam api was not created successfully");
            driver.FindElement(By.CssSelector(".orange-btn")).Click();
            Console.WriteLine("The EcoDiam api was created successfully");
        }
        [Test]
        public void XmlApiTest()
        {
            ...
            string expectedText = "Your API has been successfully created!";
            string actualText = wait.Until(ExpectedConditions.ElementIsVisible(By.CssSelector(".title"))).Text;
            Assert.That(actualText, Is.EqualTo(expectedText), "The Xml EcoDiam api was not created successfully");
            driver.FindElement(By.CssSelector(".orange-btn")).Click();
            Console.WriteLine("The Xml EcoDiam api was created successfully");
        }
        [Test]
        public void CsvApiTest()
        {
            ...
            string expectedText = "Your API has been successfully created!";
            string actualText = wait.Until(ExpectedConditions.ElementIsVisible(By.CssSelector(".title"))).Text;
            Assert.That(actualText, Is.EqualTo(expectedText), "The Csv EcoDiam api was not created successfully");
            driver.FindElement(By.CssSelector(".orange-btn")).Click();
            Console.WriteLine("The Csv EcoDiam api was created successfully");
        }
        [TearDown]
        public void CleanUp()
        {
